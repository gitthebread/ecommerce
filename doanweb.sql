...
--
-- Host: localhost:3306
-- Generation Time: May 06, 2023 at 04:29 PM
...
INSERT INTO `products` (`id`, `owner`, `name`, `color`, `size`, `price`, `quantity`, `type`, `description`, `category_id`, `image01`, `image02`, `status`) VALUES
...
INSERT INTO `shop` (`owner`, `name`, `phone`, `address`, `email`, `status`) VALUES
('cmstbita356', 'asd', 123, 'asd', 'asda', 1);
